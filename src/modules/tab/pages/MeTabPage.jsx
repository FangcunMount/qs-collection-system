...
const UserProfile = () => {
  const [userState, setUserState] = useState(() => getAccountStoreState());
  ...
  // 订阅 userStore 变化
  useEffect(() => {
    const unsubscribe = subscribeAccountStore((snapshot) => {
  ...
  const handleLoginClick = () => {
    Taro.navigateTo({ url: routes.accountRegister() });
  };
    ...
    <View className="user-profile-page">
      ...
      <View className="action-section">
        <View className="settings-card">
          <View className="settings-item" onClick={() => Taro.navigateTo({ url: routes.accountSubscription() })}>
