...
const UserRegisterFields = ({ userInfo, onChange, onUseWechatProfile }) => {
  return (
    <View>
      <View style={InputWrapperCSS}>
        ...
        <Text style={HintCSS}>昵称需要你主动确认后才能回填，头像不在注册阶段获取。</Text>
      </View>
      ...
      <View style={InputWrapperCSS}>
        ...
        <Input
          ...
          style={InputCSS}
        />
        <Text style={HintCSS}>可直接填写，也可以点击上方按钮使用微信昵称回填。</Text>
      </View>
