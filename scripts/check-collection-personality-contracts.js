...
assertContains(answersheetApi, /onDelayed/, 'answersheet readiness must expose delayed progress without failing');
assertContains(answersheetApi, /for\s*\([^;]*;\s*;[^)]*\)/, 'answersheet readiness must continue polling until a terminal result or cancellation');
...
assertContains(submissionAttempt, /v2:\$\{sha256/, 'submission fingerprint must use versioned SHA-256');
